...
public class CommandTestUtil {
    ...
    public static final String VALID_DATE_AMY = "280190";
    public static final String VALID_DATE_BOB = "201283";
    ...
    static {
        ...
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withDate(VALID_DATE_BOB).withEmail(VALID_EMAIL_BOB)
